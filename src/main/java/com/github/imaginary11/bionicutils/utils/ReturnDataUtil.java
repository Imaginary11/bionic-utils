...
import com.github.imaginary11.bionicutils.enums.HttpCode;
...
public class ReturnDataUtil<T> {
    ...
    public static <T> ReturnData getSuccussReturn(String name, T data) {
        ReturnData returnData = new ReturnData();
        if (data != null && !StringUtil.isEmpty(name)) {
    ...
    public static ReturnData systemError(String msg) {
        return StringUtil.isEmpty(msg) ? systemError() : getReturn(HttpCode.INTERNAL.getCode(), msg);
    }
    ...
    public static ReturnData invalidArgument(String msg) {
        return StringUtil.isEmpty(msg) ? invalidArgument() : getReturn(HttpCode.INVALID_ARGUMENT.getCode(), msg);
    }
    ...
    public static ReturnData permissionDeny(String msg) {
        return StringUtil.isEmpty(msg) ? permissionDeny() : getReturn(HttpCode.PERMISSION_DENIED.getCode(), msg);
    }
    ...
    public static ReturnData unAuth(String msg) {
        return StringUtil.isEmpty(msg) ? unAuth() : getReturn(HttpCode.UNAUTHENTICATED.getCode(), msg);
    }
    ...
    public static ReturnData apiNotImplement(String msg) {
        return StringUtil.isEmpty(msg) ? apiNotImplement() : getReturn(HttpCode.NOT_IMPLEMENTED.getCode(), msg);
    }
    ...
    public static ReturnData networkTimeout(String msg) {
        return StringUtil.isEmpty(msg) ? networkTimeout() : getReturn(HttpCode.DEADLINE_EXCEEDED.getCode(), msg);
    }
    ...
    public static ReturnData resourceExhausted(String msg) {
        return StringUtil.isEmpty(msg) ? resourceExhausted() : getReturn(HttpCode.RESOURCE_EXHAUSTED.getCode(), msg);
    }
    ...
    public static ReturnData resourceNotFound(String msg) {
        return StringUtil.isEmpty(msg) ? resourceNotFound() : getReturn(HttpCode.NOT_FOUND.getCode(), msg);
    }
    ...
    public static ReturnData unavailable(String msg) {
        return StringUtil.isEmpty(msg) ? unavailable() : getReturn(HttpCode.UNAVAILABLE.getCode(), msg);
    }
